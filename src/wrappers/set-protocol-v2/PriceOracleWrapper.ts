...
export default class PriceOracleWrapper {
  ...
  private masterOracleAddress: Address;

  public constructor(provider: Provider, masterOracleAddress: Address) {
    this.provider = provider;
    this.contracts = new ContractWrapper(this.provider);
    this.masterOracleAddress = masterOracleAddress;
  }
  ...
  public async getPrice(
    ...
    return await masterOracleInstance.getPrice(
      assetOne,
      assetTwo
    );
  }
